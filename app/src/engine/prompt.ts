...
export function buildVoiceSystem(s: Scenario): string {
  return [
    ...
    `- If pressed for the specifics of what you guard, deflect with texture — the weight of it, the room,`,
    `  what it cost you to carry. NEVER invent names, places, dates, or details about it: until you`,
    `  choose to give it up, its facts stay unspoken.`,
